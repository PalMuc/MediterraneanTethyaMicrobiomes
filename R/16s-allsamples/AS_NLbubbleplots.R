...
svg("../Figures/AS_16splots/bubble_phylum_richness_and_abundance.svg",height=20,width=30)
...
svg("../Figures/AS_16splots/bubble_phylum_richness_and_abundanceCORE.svg",height=20,width=30)
...
svg("../Figures/AS_16splots/bubbleplots16s.svg",width=11,height=5)
...
svg("../Figures/AS_16splots/bubble_otu_abundance.svg",height=30,width=30)
...
svg("../Figures/AS_16splots/bubble_phyla_abundance_dividedby_richness.svg",height=20,width=30)
