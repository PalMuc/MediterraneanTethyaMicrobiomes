...
svg("../Figures/AS_16splots/nmdsplot_16s.svg")
...
svg("../Figures/AS_16splots/ccaplot_16s.svg")
...
svg("../Figures/AS_16splots/nmdsplot_core16s.svg",height=8,width=8)
...
svg("../Figures/AS_16splots/ccaplot_core16s.svg",height=8,width=8)
...
svg("../Figures/AS_16splots/nmdsplot_noncore16s.svg",height=8,width=8)
...
svg("../Figures/AS_16splots/2ccaplot_noncore16s.svg",height=8,width=8)
...
svg("../Figures/AS_16splots/heatmap_variability_16s_allotus.svg",height=8,width=8)
...
svg("../Figures/AS_16splots/heatmap_variability_16s_allotusfull.svg",height=30,width=30)
...
svg("../Figures/AS_16splots/heatmap_25mostvariable_otus.svg",height=8,width=8)
