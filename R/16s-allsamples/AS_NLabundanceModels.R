...
setwd("~/Repos/Mediterranean_Tethya/Mediterranean_Tethya/R/")
...
#svglite("../Figures/AS_16splots/AS16s_phylumrad_grouped.svg",width=8,height=8)
svg("../Figures/AS_16splots/AS16s_phylumrad_grouped.svg",width=8,height=8)
par(mfrow=c(3,4))
#For sp 1
...
svg("../Figures/AS_16splots/otuRADplot_no_unclassified.svg",height=20,width=10)
...
svg("../Figures/AS_16splots/radplototu.svg",width=8,height=8)
xotuRADPlot
dev.off()
#For specie T. auratis
...
svg("../Figures/AS_16splots/xoturad_grouped.svg",width=8,height=8)
...
svg("../Figures/AS_16splots/allOTU16radtest.svg",height=20,width=35)
par(mfrow=c(1,2),mai=c(1,1,1,1))
...
svg("../Figures/AS_16splots/tauOTU16radtest.svg",height=20,width=35)
par(mfrow=c(1,2),mai=c(1,1,1,1))
...
svg("../Figures/AS_16splots/tmeOTU16radtest.svg",height=20,width=35)
par(mfrow=c(1,2),mai=c(1,1,1,1))
...
svg("../Figures/AS_16splots/tciOTU16radtest.svg",height=20,width=35)
par(mfrow=c(1,2),mai=c(1,1,1,1))
...
svg("../Figures/AS_16splots/allsp_otu16radtest.svg",height=20,width=60)
