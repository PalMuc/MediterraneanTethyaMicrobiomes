...
svg("../Figures/AS_16splots/relativeabundanceallphyla.svg",height=10,width=20)
...
svg("../Figures/AS_16splots/relativeabundance-corephyla.svg",height=10,width=20)
...
svg("../Figures/AS_16splots/stackedbar16s.svg",width=14,height=7)
...
svg("../Figures/AS_16splots/relativeabundance-non-corephyla.svg",height=10,width=20)
...
svg("../Figures/AS_16splots/relativeabundance-coreotus-betweensp.svg",height=20,width=30)
...
svg("../Figures/AS_16splots/highabundance-coreotusv1.svg",height=20,width=20)
...
svg("../Figures/AS_16splots/highabundance-coreotusv2.svg",height=10,width=30)
...
svg("../Figures/AS_16splots/lowabundance-coreotusv1.svg",height=20,width=30)
...
svg("../Figures/AS_16splots/lowabundance-coreotusv2.svg",height=10,width=80)
...
svg("../Figures/AS_16splots/coreotusbargraph.svg",height=10,width=20)
...
svg("../Figures/AS_16splots/highabundance_otusgraph.svg",height=20,width=30)
...
svg("../Figures/AS_16splots/lowabundance_otusgraphlong.svg",height=30,width=100)
...
svg("../Figures/AS_16splots/lowabundance_otusgraph.svg",height=30,width=60)
