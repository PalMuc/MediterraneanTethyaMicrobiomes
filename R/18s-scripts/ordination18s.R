...
svg("Figures/18splots/ordi_nmds_18s2.svg",height=8,width=8)
...
svg("Figures/18splots/ordi_cca_18s.svg",height=8,width=8)
...
svg("Figures/18splots/heatmap_all_18s.svg", height=8,width=8)
...
svg("Figures/18splots/heatmap_all_18sfull.svg",height=25,width=25)
...
svg("Figures/18splots/heatmap_25mostvariable_18s.svg",height=8,width=8)
