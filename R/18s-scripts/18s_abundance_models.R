...
svg("Figures/18splots/phylumRADplot.svg",width=30,height=30)
...
svg("Figures/18splots/18s_phylumrad_grouped.svg",width=30,height=30)
par(mfrow=c(3,4))
#For sp 1
...
svg("Figures/18splots/18s_phylumradtest.svg",width=40,height=20)
...
svg("Figures/18splots/otuRADplot.svg",width=30,height=30)
otuRADPlot
dev.off()
...
svg("Figures/18splots/full_otuRADplot.svg",width=30,height=30)
xotuRADPlot
dev.off()
...
svg("./Figures/18splots/xoturad_grouped2.svg",width=8,height=8)
...
svg("Figures/18splots/allOTU18radtest.svg",height=20,width=35)
par(mfrow=c(1,2),mai=c(1,1,1,1))
...
svg("Figures/18splots/tauOTU18radtest.svg",height=20,width=35)
par(mfrow=c(1,2),mai=c(1,1,1,1))
...
svg("Figures/18splots/tmeOTU18radtest.svg",height=20,width=35)
par(mfrow=c(1,2),mai=c(1,1,1,1))
...
svg("Figures/18splots/tciOTU18radtest.svg",height=20,width=35)
par(mfrow=c(1,2),mai=c(1,1,1,1))
...
#all 3 together
svg("Figures/18splots/allsp_otu18radtest.svg",height=20,width=60)
