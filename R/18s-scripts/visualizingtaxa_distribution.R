...
svg("./Figures/18splots/overall18s_class_distribution.png",width=15, height=5)
...
svg("./Figures/18splots/overall18s_taxa_distributionunclass.svg",width=18, height=7)
...
##########
head(datatau)
svg("./Figures/18splots/tau18s_taxa_distribution2.svg", width=6, height=5)
...
svg("./Figures/18splots/tme18s_taxa_distribution2.svg",width=6, height=5)
...
svg("./Figures/18splots/tci18s_taxa_distribution2.svg",width=6, height=5)
