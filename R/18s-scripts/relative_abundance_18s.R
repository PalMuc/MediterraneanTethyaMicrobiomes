...
ggsave("relative_abundances_18s.svg",path=plotsPath,width=30,height=20)
...
ggsave("2relative_abundances_18s_wo_unclassandporifera.svg",path=plotsPath,width=30,height=20)
...
ggsave("2relative_abundances_18s_wo_unclass.svg",path=plotsPath,width=30,height=20)

###################
#coreOTUs
#png("./Figures/18splots/relativeabundance-corephyla.png",height=10,width=20,units="cm",res=300)
svg("./Figures/18splots/relativeabundance-corephyla.svg",height=10,width=20)
...
svg("./Figures/18splots/relativeabundance-corephyla_wounclass.svg",height=10,width=20)
...
svg("Figures/18splots/stackedbar18s_wandwo_sponge.svg",width=14,height=7)
...
ggsave("Freq_of_otu.svg",path=plotsPath,width=30,height=20)
...
svg("./Figures/18splots/highabundance_otusgraph.svg",height=20,width=30)
...
svg("./Figures/18splots/lowabundance_otusgraphlongwzero.svg",height=30,width=100)
...
svg("./Figures/18splots/lowabundance_otusgraphwzero.svg",height=30,width=60)
ggplot(ndata_low, aes(X.OTU.ID, y=value)) +
  geom_boxplot(aes(fill=Phylum)) + geom_jitter(colour="gray80", alpha=0.65) +
  facet_grid(cols=vars(variable)) +  facet_wrap(~variable,nrow=3)+
  scale_fill_manual(values = c(Unclassified,Mollusca,Cnidaria,Bryoza,Porifera,Ciliophora,Annelida,Dinoflagellata,
...
ggsave("phylum_richness_and_abundance_bubble.svg",path=plotsPath,width=30,height=20)
...
ggsave("phylum_richness_and_abundance_bubble_wo_unclass.svg",path=plotsPath,width=30,height=20)
...
svg("./Figures/18splots/18bubble_phylum_richness_and_abundanceCORE.svg",height=20,width=30)
...
svg("./Figures/18splots/18bubble_phylum_richness_and_abundanceCORE_wounclass.svg",height=20,width=30)
...
svg("Figures/18splots/bubbleplots18s_2.svg",width=14,height=7)
...
ggsave("Figures/18splots/phylum_rich_and_abund_bubble_withoutunclass-porifera.svg",width=30,height=20)
...
svg("Figures/18splots/bubbleplots18s_wo_unclass.svg",width=14,height=7)
